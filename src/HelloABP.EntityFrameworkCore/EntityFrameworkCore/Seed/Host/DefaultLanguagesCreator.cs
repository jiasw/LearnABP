...
namespace HelloABP.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly HelloABPDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = HelloABPConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(HelloABPDbContext context)
        {
            _context = context;
        }
